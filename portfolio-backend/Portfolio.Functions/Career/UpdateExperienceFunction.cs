...
public class UpdateExperienceFunction(UpdateExperienceService service)
{
    [Function("UpdateExperience")]
    public async Task<IActionResult> Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "put", Route = "experiences/{id:guid}")] HttpRequest req,
        Guid id,
